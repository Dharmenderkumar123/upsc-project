...
import com.the_pride_ias.databinding.ItemCategoryCourseRecyclerBinding


class CoursesAdaptor(val context: Context, private val dataSet: MutableList<Courses>) :
    RecyclerView.Adapter<CoursesAdaptor.ViewHolder>() {
    inner class ViewHolder(val binding: ItemCategoryCourseRecyclerBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemCategoryCourseRecyclerBinding.inflate(
...
//        val itemWidth = (screenWidth / 2) - (marginPx * 2)
