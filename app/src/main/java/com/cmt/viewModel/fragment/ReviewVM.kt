...
class ReviewVM : ViewModel() {
    var reviewData: MutableLiveData<MutableList<ReviewAnswersModel>> = MutableLiveData()

    fun setData(context: Context, examId: String) {
        ...
        TestModuleAPI().reviewAnswerList(params, object : RetrofitCallBack {
